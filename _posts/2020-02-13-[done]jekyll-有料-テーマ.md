...
## Just Good Themes社のテーマ

[Just Good Themes社](https://jekyllthemes.io/developers/just-good-themes)のテーマは、7のテーマを販売。高品質に見えるが、あまり企業向けではない。

### Royce Jekyll themeテーマ

![](../assets/images/2020-02-14-06-42-13.png)
[デモ](https://royce.netlify.com/)

||モバイル|デスクトップ|
|--|--|--|
|PageSpeed Insights|88|92|
...
[デモ](https://gizmoder.com/demo/html/omnivus/omnivus/index.html)
...
テーマは、[マイクハマー氏のサイト](https://jekyllthemes.io/)から選ぶ。発売日の新しいテーマを選ぶこと。気に入ったテーマをが見つかったら、PageSpeedで評価するべし。

# おまけ

### Blackrockdigitalテーマ at Github

アシッシュ君推薦。無料テーマ。ソースコード公開あり。
